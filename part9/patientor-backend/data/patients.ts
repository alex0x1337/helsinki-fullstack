...
const getPatientsPublic = (): PatientPublic[] => patients.map(({ id, name, dateOfBirth, gender, entries, occupation } : Patient) => ({
    id,
    name,
    dateOfBirth,
    gender,
...
export default { patients, getPatientsPublic, getPatientById, addPatient };